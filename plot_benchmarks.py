...
plt.grid(True)
plt.tight_layout()
plt.savefig("benchmark_plots/runtime_all.png", dpi=300)
print("Generated: benchmark_plots/runtime_all.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("benchmark_plots/memory_usage_all.png", dpi=300)
print("Generated: benchmark_plots/memory_usage_all.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("benchmark_plots/speedup_all.png", dpi=300)
print("Generated: benchmark_plots/speedup_all.png")
